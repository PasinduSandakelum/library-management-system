<%-- 
    Document   : EditSub
    Created on : Aug 22, 2018, 10:06:30 AM
    Author     : pasindu
--%>
        ...
        <div id="breadcrumb">
            <div class="container">	
                <div class="breadcrumb">							
                    ...
                    <li>Update Sub Classification</li>		
                </div>		
            </div>	
        </div>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="addForm" method="get" class="form-horizontal" action="UpdateSub">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Enter Sub Classification ID" name="subId" id="subId" value="${subId}" readonly/>
                                    </div>
